...
public class PrinterUtils2 extends AsyncTask<String, Void, Integer> {
    ...
    public PrinterUtils2(Context context, List<Receipt> transaction, CacheUtil cacheUtil) {
