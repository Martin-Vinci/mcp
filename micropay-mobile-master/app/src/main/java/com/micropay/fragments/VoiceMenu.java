...
import com.micropay.fragments.transactions.TXNAirtelVoicePurchase;
import com.micropay.fragments.transactions.TXNAirtelVoicePurchaseAgent;
import com.micropay.fragments.transactions.TXNMTNVoice;
import com.micropay.fragments.transactions.TXNMTNVoiceAgent;
...
public class VoiceMenu extends Fragment implements ItemClickListener {
...
//                    .put("icon", R.drawable.account));
    ...
    public void onClick(View view, int position) {
        ...
        switch (position) {
            case 0:
                cacheUtil.putString(Constants.MENU, "Airtel Voice");
                fragment = entityType.equalsIgnoreCase("CUSTOMER") ? new TXNAirtelVoicePurchase() : new TXNAirtelVoicePurchaseAgent();
            ...
            case 1:
                //Customer
                cacheUtil.putString(Constants.MENU, "MTN Voice");
                fragment = entityType.equalsIgnoreCase("CUSTOMER") ? new TXNMTNVoice() : new TXNMTNVoiceAgent();
                getActivity().getSupportFragmentManager().beginTransaction()
                        .setTransition(FragmentTransaction.TRANSIT_FRAGMENT_OPEN)
                        .replace(R.id.container, fragment).addToBackStack(null)
                        .commit();
