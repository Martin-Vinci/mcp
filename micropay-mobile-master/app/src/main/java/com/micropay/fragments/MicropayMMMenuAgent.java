...
public class MicropayMMMenuAgent extends Fragment implements ItemClickListener {
    ...
    private JSONArray getMenu() {
        ...
        try {
            jsonArray.put(0, new JSONObject().put("label", "Cash In").put("sub_title", "Cash In")
                    .put("icon", R.drawable.cash_deposit));
            jsonArray.put(1, new JSONObject().put("label", "Cash Out").put("sub_title", "Cash Out")
                    .put("icon", R.drawable.withdraw));
            jsonArray.put(2, new JSONObject().put("label", "Voucher Redeem").put("sub_title", "Voucher Redeem")
                    .put("icon", R.drawable.voucher_redeem));
