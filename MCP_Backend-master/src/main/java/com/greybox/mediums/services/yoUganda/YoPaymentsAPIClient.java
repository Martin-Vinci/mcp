...
public class YoPaymentsAPIClient {
     ...
     * @return String
     */
    public String createWithdrawalXml(BigDecimal Amount, String BeneficiaryPhone,String Narrative){
...
//                checkExternalReference(ExternalReference)+
     ...
     * @return String
     */
    public String createDepositXml(BigDecimal Amount, String FundsSourcePhone, String Narrative){
        return "<?xml version='1.0' encoding='UTF-8'?>" + 
        "<AutoCreate>" + 
            "<Request>" + 
                "<APIUsername>"+APIUsername+"</APIUsername>" + 
    ...
    public YoPaymentsResponse executeYoPaymentsRequest(String inputXML, String serviceUrl)
        ...
        String result = null;
        logError(DataUtils.toTimeString(new Date()) + ": Request URL => " + serviceUrl);
        logError(DataUtils.toTimeString(new Date()) + ": YoUganda Request PayLoad ==================> " + inputXML);
        ...
        logError(DataUtils.toTimeString(new Date()) + ": YoUganda Response ==================> " + result);
